  ...
  "challenges": [
    ...
    },
    {
      ...
      "variants": [
        ...
        { "id": "v3", "title": "Swap Variables", "description": "Swap two variables a=5, b=10 and print them.", "functionSignature": "// inline", "testCases": [{ "input": "a=5, b=10", "output": "a=10, b=5" }], "hints": [{ "title": "🤔 Think about it", "content": "How do you swap two values without losing one of them? Think about what happens if you just write a = b." }, { "title": "💡 Hint", "content": "Go has a special syntax for simultaneous assignment: a, b = b, a. This evaluates the right side first, then assigns, so nothing is lost." }, { "title": "👀 Show me", "content": "<pre>a, b = b, a</pre>" }], "solution": "a, b := 5, 10\na, b = b, a\nfmt.Println(a, b)" }
      ]
    },
    {
