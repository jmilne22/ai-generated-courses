...
function updateStats() {
    ...
    const exerciseProgress = JSON.parse(localStorage.getItem('go-course-exercise-progress') || '{}');
...
function clearProgress() {
    if (confirm('Clear all progress? This cannot be undone.')) {
        ...
        localStorage.removeItem('go-course-exercise-progress');
        localStorage.removeItem('go-course-srs');
        localStorage.removeItem('go-course-streaks');
        localStorage.removeItem('go-course-activity');
        location.reload();
    }
}
