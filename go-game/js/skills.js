...
(function() {
    ...
    var MILESTONES = [
        { level: 10, label: 'Concept tutorial unlocked' },
        { level: 20, label: 'Reduced hint XP penalty (-5 instead of -10)' },
        { level: 30, label: 'Timer extended (+15s)' },
        { level: 40, label: 'Bonus XP multiplier 1.1x' },
        { level: 50, label: 'Persona evolution' }
    ];
    ...
    function renderStatsView() {
        ...
        html += '<div class="skill-header">' +
            ...
            '<div class="skill-info">' +
                '<div class="skill-name">' + player.name + '</div>' +
                '<div class="skill-xp-info">' + player.totalXP + ' total XP &bull; ' + completedCount + ' shadows defeated</div>' +
