...
(function() {
    ...
    function renderInfiltrationView() {
        ...
        html += '<div class="infiltration-palace">' + palace.name + '</div>';
        html += '<div class="infiltration-floor">FLOOR ' + floor.number + ' / ' + CONFIG.floorsPerRun + '</div>';
        html += '</div>';
        ...
        html += '<div class="security-label">SECURITY LEVEL</div>';
        ...
        html += '<div class="xp-label">RUN XP</div>';
        ...
        html += '<span class="floor-type-name">' + floor.type.name + '</span>';
        html += '<span class="floor-type-desc">' + floor.type.desc + '</span>';
        html += '</div>';
        ...
        floor.exercises.forEach(function(exData, idx) {
            ...
            html += '<div class="exercise-number">Shadow ' + (idx + 1) + '</div>';

            if (statusClass === 'completed') {
                html += '<div class="exercise-status">DEFEATED</div>';
                ...
                html += '<button class="engage-btn" data-idx="' + idx + '">ENGAGE</button>';
            } else {
        ...
        html += '<button class="retreat-btn" id="retreat-btn">RETREAT (Keep 50% XP)</button>';
        html += '</div>';
        ...
        document.getElementById('retreat-btn').addEventListener('click', function() {
            if (confirm('Retreat from the palace? You\'ll keep 50% of earned XP.')) {
    ...
    function renderRetreatScreen(reason, partialXP) {
        ...
        html += '<div class="result-title">RETREAT</div>';
        html += '<div class="result-reason">' + reason + '</div>';
        html += '<div class="result-stats">';
        html += '<div class="stat">Floors Cleared: ' + infiltration.currentFloor + '/' + CONFIG.floorsPerRun + '</div>';
        html += '<div class="stat">XP Earned: ' + partialXP + ' (50% penalty)</div>';
        html += '<div class="stat">Final Security: ' + infiltration.security + '%</div>';
        html += '</div>';
        html += '<button class="return-btn" id="return-palace-btn">Return to Palace Select</button>';
        html += '</div>';
    ...
    function renderVictoryScreen() {
        ...
        html += '<div class="result-icon">🎭</div>';
        html += '<div class="result-title">INFILTRATION COMPLETE</div>';
        html += '<div class="result-palace">' + infiltration.palaceKey.toUpperCase() + '\'S PALACE</div>';

        html += '<div class="result-stats">';
        html += '<div class="stat-row"><span>Floors Cleared</span><span>' + CONFIG.floorsPerRun + '/' + CONFIG.floorsPerRun + '</span></div>';
        html += '<div class="stat-row"><span>Base XP</span><span>' + (infiltration.totalXP - infiltration.bonusXP) + '</span></div>';

        if (infiltration.bonusXP > 0) {
            html += '<div class="stat-row bonus"><span>Bonus XP</span><span>+' + infiltration.bonusXP + '</span></div>';
        }

        html += '<div class="stat-row total"><span>Total XP</span><span>' + infiltration.totalXP + '</span></div>';
        html += '<div class="stat-row"><span>Final Security</span><span>' + infiltration.security + '%</span></div>';
        html += '<div class="stat-row"><span>Perfect Floors</span><span>' + infiltration.perfectFloors + '/' + CONFIG.floorsPerRun + '</span></div>';
        html += '</div>';

        html += '<button class="return-btn" id="return-palace-btn">Continue</button>';
        html += '</div>';
    ...
    // Export
    window.PalaceMode = {
        startInfiltration: startInfiltration,
        renderPalaceView: renderPalaceView,
